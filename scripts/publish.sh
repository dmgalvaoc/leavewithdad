...
# Note: index.html (home page card) must be staged by Cowork before this runs
git -C "$REPO" add "$SLUG/" index.html events.json sitemap.xml 2>/dev/null || true
