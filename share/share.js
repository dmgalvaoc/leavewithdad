...
(function () {
  ...
  function buildBar(container) {
    ...
    container.innerHTML = `
      <span class="lwd-share-label">Share</span>
      <button class="lwd-share-btn lwd-share-btn--copy" id="lwd-copy">${icons.copy} Copy link</button>
      <a class="lwd-share-btn" href="${fbUrl}" target="_blank" rel="noopener">${icons.facebook} Facebook</a>
      <a class="lwd-share-btn" href="${liUrl}" target="_blank" rel="noopener">${icons.linkedin} LinkedIn</a>
      <button class="lwd-share-btn lwd-share-btn--instagram" id="lwd-instagram">${icons.instagram} Instagram</button>
      <a class="lwd-share-btn" href="${emUrl}">${icons.email} Email</a>
      ${hasNativeShare ? `<button class="lwd-share-btn lwd-share-btn--native" id="lwd-native">${icons.share} Share</button>` : ''}
    `;
    ...
    const nativeBtn = container.querySelector('#lwd-native');
    if (nativeBtn) {
